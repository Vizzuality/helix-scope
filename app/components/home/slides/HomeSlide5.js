...
function HomeSlide5() {
  return (
    <TextSlide
      ...
      content="If the global temperature increases by 4ºC, more than 60% of the planet
       species studied become increasingly vulnerable to extinction. If we change
       our behaviour and limit warming to 2ºC the risk it halved."
      buttons={[
        {
