...
export const CONFIG_CATEGORIES_VARIABLES_COUNTRY = {
  'ag': [
...
export const CONFIG_CATEGORIES_VARIABLES_MAP = {
  'bd': [
    'amphibianobiodiversity',
    'birdrealbiodiversity',
    'reptilerealbiodiversity',
...
export const CONFIG_VARIABLES_NAMES_SHORT = {
...
export const CONFIG_VARIABLE_NAMES_LONG = {
...
export const CONFIG_VARIABLES_LABELS = {
...
export const CONFIG_VARIABLES_UNITS = {
  'Maize_Irrigation_avoided_perc_change': '%',
  'Maize_yield_perc_change': '%',
  'Rice_Irrigation_avoided_perc_change': '%',
  'Rice_yield_perc_change': '%',
